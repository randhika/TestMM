...
public class Container
{
    ...
    public boolean getBoolean(String s)
    {
        ...
        {
            bh.A((new StringBuilder()).append("Calling getBoolean() threw an exception: ").append(exception.getMessage()).append(" Returning default value.").toString());
            return dh.na().booleanValue();
        }
        return flag;
    }
    ...
    public double getDouble(String s)
    {
        ...
        {
            bh.A((new StringBuilder()).append("Calling getDouble() threw an exception: ").append(exception.getMessage()).append(" Returning default value.").toString());
            return dh.mZ().doubleValue();
        }
        return d;
    }
    ...
    public long getLong(String s)
    {
        ...
        {
            bh.A((new StringBuilder()).append("Calling getLong() threw an exception: ").append(exception.getMessage()).append(" Returning default value.").toString());
            return dh.mY().longValue();
        }
        return l;
    }
    ...
    public String getString(String s)
    {
        ...
        {
            bh.A((new StringBuilder()).append("Calling getString() threw an exception: ").append(exception.getMessage()).append(" Returning default value.").toString());
            return dh.nc();
        }
        return s1;
    }
