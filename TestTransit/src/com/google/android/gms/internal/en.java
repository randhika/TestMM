...
public final class en
{
    ...
    public static void execute(Runnable runnable)
    {
        ...
        {
            eu.c((new StringBuilder()).append("Too many background threads already running. Aborting task.  Current pool size: ").append(getPoolSize()).toString(), rejectedexecutionexception);
        }
    }
