        ...
        if (!ib1.b(class1))
        {
            ...
            do
            {
                ...
                if (class2 != null)
                {
                    ...
                    {
                        throw new IllegalStateException((new StringBuilder()).append("Could not instantiate an object of type ").append(a1.fO().getCanonicalName()).toString(), instantiationexception);
                    }
                    catch (IllegalAccessException illegalaccessexception)
                    {
                        throw new IllegalStateException((new StringBuilder()).append("Could not access object of type ").append(a1.fO().getCanonicalName()).toString(), illegalaccessexception);
                    }
                }
            } while (true);
        }
