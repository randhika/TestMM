...
public class YConnectImplicit
{
    ...
    private ImplicitCallbackUriParser responsePaser;
    ...
    {
        responsePaser = new ImplicitCallbackUriParser(uri, s);
        accessToken = responsePaser.getAccessToken(s1);
        idToken = responsePaser.getIdToken();
    }
