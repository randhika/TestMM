    ...
    implements android.content.lickListener
{
    ...
    public void onClick(DialogInterface dialoginterface, int i)
    {
        ...
        ditor.putInt("recommend_key", 2);
        ditor.putInt("ver_key", TransitUtil.getVersionCode(RequestRecommend.access$100(RequestRecommend.this)));
        ditor.commit();
        TransitUtil.touchRD(RequestRecommend.access$100(RequestRecommend.this).getString(0x7f0d0559));
        RequestRecommend.recommend(RequestRecommend.access$100(RequestRecommend.this));
    }
