    ...
    implements jp.co.yahoo.android.apps.transit.api.stener
{
    ...
    public boolean onError(APIError apierror)
    {
        if (val$listener != null)
        {
            if (apierror == null)
            {
                val$listener.onError(4, "-1", PushDiainfoManager.access$200(PushDiainfoManager.this).getString(0x7f0d014f), PushDiainfoManager.access$200(PushDiainfoManager.this).getString(0x7f0d0102));
            } else
            {
