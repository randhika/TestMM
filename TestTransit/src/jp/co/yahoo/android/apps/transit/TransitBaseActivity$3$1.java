...
class ambergerEntry
    implements android.view.sitBaseActivity._cls3._cls1
{
    ...
    {
        Intent intent = getPackageManager().getLaunchIntentForPackage(val$entry.mPackage);
...
_L5:
            TransitBaseActivity._cls3._cls1 _lcls1 = entry. new TransitBaseActivity._cls3._cls1();
            linearlayout1.setOnClickListener(_lcls1);
_L7:
            int k = i + 1;
...
_L6:
            android.view.View.OnClickListener onclicklistener = new TransitBaseActivity._cls3._cls2();
...
_L8:
        ...
        // Unreferenced inner class jp/co/yahoo/android/apps/transit/TransitBaseActivity$3$2

/* anonymous class */
        class TransitBaseActivity._cls3._cls2
