    ...
    implements android.content.er
{
    ...
    {
        SearchResultTeikiActivity.access$400(_fld0);
    }
    ...
    // Unreferenced inner class jp/co/yahoo/android/apps/transit/SearchResultTeikiActivity$2

/* anonymous class */
    class SearchResultTeikiActivity._cls2
        implements jp.co.yahoo.android.apps.transit.api.ApiBase.ApiListener
    {
        ...
        public boolean onError(APIError apierror)
        {
            ...
            showSimpleErrorMessageDialog(s, new SearchResultTeikiActivity._cls2._cls1(), new SearchResultTeikiActivity._cls2._cls2());
            return false;
        }
...
_L2:
            ...
            {
                SearchResultTeikiActivity.access$102(SearchResultTeikiActivity.this, (jp.co.yahoo.android.apps.transit.api.data.NaviSearchData.NaviRouteData)navisearchdata.routes.get(0));
            } else
            {
                ...
                SearchResultTeikiActivity.access$202(SearchResultTeikiActivity.this, (jp.co.yahoo.android.apps.transit.api.data.NaviSearchData.NaviRouteData)navisearchdata.routes.get(0));
            }
_L4:
...
_L3:
            SearchResultTeikiActivity.access$302(SearchResultTeikiActivity.this, (jp.co.yahoo.android.apps.transit.api.data.NaviSearchData.NaviRouteData)navisearchdata.routes.get(0));
              goto _L4
...
_L5:
        ...
        // Unreferenced inner class jp/co/yahoo/android/apps/transit/SearchResultTeikiActivity$2$1

/* anonymous class */
        class SearchResultTeikiActivity._cls2._cls1
