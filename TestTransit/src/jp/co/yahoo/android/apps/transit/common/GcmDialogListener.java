...
public class GcmDialogListener
    implements android.content.DialogInterface.OnClickListener
{
    ...
    public GcmDialogListener(Activity activity, Intent intent, int i)
    {
        oe = activity;
        FS = null;
        mIntent = intent;
    ...
    public GcmDialogListener(Fragment fragment, Intent intent, int i)
    {
        oe = null;
        FS = fragment;
        mIntent = intent;
