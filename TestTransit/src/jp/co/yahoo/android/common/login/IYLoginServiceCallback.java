...
public interface IYLoginServiceCallback
    extends IInterface
{
        ...
        implements IYLoginServiceCallback
    {
        ...
        public static IYLoginServiceCallback asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("jp.co.yahoo.android.common.login.IYLoginServiceCallback");
    ...
    public abstract void receiveMessage(String s, String s1, String s2)
        throws RemoteException;
}
