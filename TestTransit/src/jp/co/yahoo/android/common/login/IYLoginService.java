    ...
    extends IInterface
{
        ...
        implements IYLoginService
    {
        ...
        public static IYLoginService asInterface(IBinder ibinder)
        {
            ...
            IInterface iinterface = ibinder.queryLocalInterface("jp.co.yahoo.android.common.login.IYLoginService");
            ...
            throws RemoteException
        {
            ...
            case 5: // '\005'
                parcel.enforceInterface("jp.co.yahoo.android.common.login.IYLoginService");
                registerCallback(IYLoginServiceCallback.Stub.asInterface(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;

            case 6: // '\006'
                parcel.enforceInterface("jp.co.yahoo.android.common.login.IYLoginService");
                unregisterCallback(IYLoginServiceCallback.Stub.asInterface(parcel.readStrongBinder()));
                parcel1.writeNoException();
                return true;
...
_L1:
    ...
    public abstract void cancelCredential()
        throws RemoteException;
    ...
    public abstract String getStoredYID()
        throws RemoteException;

    public abstract String getYID()
        throws RemoteException;
    ...
    public abstract void registerCallback(IYLoginServiceCallback iyloginservicecallback)
        throws RemoteException;

    public abstract void requestCredential()
        throws RemoteException;

    public abstract boolean requestingCredential()
        throws RemoteException;
    ...
    public abstract void unregisterCallback(IYLoginServiceCallback iyloginservicecallback)
        throws RemoteException;
}
