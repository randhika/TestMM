...
_L1:
        AdSdkBrowserActivity.access$700(a).setImageBitmap(AdSdkBrowserActivity.access$600(a));
_L4:
        return false;
_L2:
        if (motionevent.getAction() == 1)
        {
            AdSdkBrowserActivity.access$700(a).setImageBitmap(AdSdkBrowserActivity.access$800(a));
        }
