...
//            SerializerBase, StdSerializerProvider

static final class  extends SerializerBase
{
    ...
    {
        if (serializerprovider.isEnabled(org.codehaus.jackson.map.ure.FAIL_ON_EMPTY_BEANS))
        {
            failForEmpty(obj);
        }
