    ...
    implements BeanProperty
{
    ...
    {
        org.codehaus.jackson.map.ser.impl.PropertySerializerMap.SerializerAndMapResult serializerandmapresult;
        if (_nonTrivialBaseType != null)
        {
            serializerandmapresult = propertyserializermap.findAndAddSerializer(_nonTrivialBaseType.forcedNarrowBy(class1), serializerprovider, this);
        } else
        {
    ...
    {
        HashMap hashmap = _internalSettings;
        Object obj1 = null;
        if (hashmap != null)
        {
            obj1 = _internalSettings.remove(obj);
