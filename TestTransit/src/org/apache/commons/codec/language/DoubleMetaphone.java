...
_L7:
    ...
    private boolean conditionL0(String s, int i)
    {
        ...
        return (contains(s, i - 1, 2, "AS", "OS") || contains(s, -1 + s.length(), 1, "A", "O")) && contains(s, i - 1, 4, "ALLE");
    }
...
_L4:
        if (!s1.equals(as[i1])) goto _L6; else goto _L5
_L5:
        flag = true;
_L2:
        return flag;
...
_L7:
    ...
    private int handleC(String s, DoubleMetaphoneResult doublemetaphoneresult, int i)
    {
        ...
        {
            j = handleCH(s, doublemetaphoneresult, i);
        } else
    ...
    public String doubleMetaphone(String s, boolean flag)
    {
        ...
        do
        {
            if (!doublemetaphoneresult.isComplete() && i <= -1 + s1.length())
            {
                ...
                case 85: // 'U'
                case 89: // 'Y'
                    i = handleAEIOUY(s1, doublemetaphoneresult, i);
                    break;
